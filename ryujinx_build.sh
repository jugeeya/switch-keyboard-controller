...
RYUJINX_APPLICATION_PATH="/mnt/c/Users/Jdsam/Downloads/ryujinx-1.1.293-win_x64/publish/Ryujinx.exe"
...
cp target/aarch64-skyline-switch/release/libswitch_keyboard_controller.nro $RYUJINX_SMASH_SKYLINE_PLUGINS_PATH
